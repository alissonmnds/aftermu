...
// ************************************************************** //
/*****************************************************************************
    @ Template Settings by ViciadosMu.com.br
*****************************************************************************/
//Slides
define("L_Slide", false); // -- Mostrar Slide na página principal? (true=sim / false=não)

//Link da imagens
define("L_ImgSlide", "images/slider/slide01.jpg"); // -- 1º imagem do slide
define("L_ImgSlide2", "images/slider/slide02.jpg"); // -- 2º imagem do slide
define("L_ImgSlide3", "images/slider/slide03.jpg"); // -- 3º imagem do slide
define("L_ImgSlide4", "images/slider/slide04.jpg"); // -- 4º imagem do slide
define("L_ImgSlide5", "images/slider/slide05.jpg"); // -- 5º imagem do slide
//Link dos slides
...
define("L_Youtube", "http://youtube.com"); // -- Link do Youtube
//Outras configurações
define("L_KingOfPVP", "ViciadosMu"); // -- Rei do PVP
define("L_CharKingOfPVP", "ViciadosMu"); // -- Personagem Rei do PVP
...
//Outras configurações de Templates Diferentes
define("SHOW_SLIDE", true); // -- Opção Template Connect - Mostrar Slide na página principal? (true=sim / false=não)
define("TOP1_GUILD", true); // -- Opção Template Connect - Mostrar "Melhor Guild" na página principal? (true=sim / false=não)
define("TUKKER_DoadorMes", "ViciadosMu"); // -- Opção Template TUKKER --- DoadorMes
define("TUKKER_ValorDoadorMes", "0,00"); // -- Opção Template TUKKER --- DoadorMes
define("Show_ChatHome", true); // -- Opção Template TUKKER --- Exbir Chat (true=sim / false=não)
...
*****************************************************************************/
$_Mailer["SMTP"]["Server"] = "smtp.seudominio.com.br"; // -- Host do Servidor SMTP (Padrão -> localhost)
$_Mailer["SMTP"]["Port"] = 25; // -- Porta do Servidor SMTP (Padrão -> 25)
$_Mailer["SMTP"]["User"] = "contato@seudominio.com.br"; // -- Usuario do Servidor SMTP (Padrão -> Vazio)
$_Mailer["SMTP"]["Pass"] = "senhaSMTP"; // -- Senha do Servidor SMTP (Padrão -> Vazio)
$_Mailer["SMTP"]["Mail"] = "contato@seudominio.com.br"; // -- Remetente dos E-Mails
...
define("VI_CURR_INFO", true); // -- Registrar dados na Tabela VI_CURR_INFO (Padrão -> true)
...
define("Max_Points", 32767); // -- Maximo de Pontos
define("Server_Files", 3); // -- Server Files [0=ENCGames Season 6] [1=X-Team Season 4/5] [2=X-Team Season 6] [3=Outros]
define("GS_Version", 0); // -- Server Version [0=99B-] [1=99Z a Season 1] [2=Season 2] [3=Season 3 EP1] [4=Season 3 EP2 a Season 4.5] [5=Season 5] [6=Season 6 EP1] [7=Season 6 EP2/3]
...
define("NEWFINAL_REF_LINK", "http://www.seudominio.com.br/?ref="); // -- Link de referência

/*****************************************************************************
	@ Template Settings
	@ Configurações do Sistema de Template
	@ Para o template Padrão deixe "Especial"
*****************************************************************************/
define("Template_Default", "Especial"); // -- Nome da pasta do Template na pasta "templates" (Template Padrão)
...
##################################################################
$_Templates = array(0 => array("Especial", "Especial"),
					1 => array("Especial", "Especial"),
				   );
...
*****************************************************************************/
define("Update_Key",0x6D42C701); // -- Chave de Atualização. (Pegue no ChangeLog.htm)
...
/*****************************************************************************
	...
	@ false = Não
*****************************************************************************/
define("Server_Name", "ViciadosMu"); // -- Nome do Servidor
define("Web_Title", "ViciadosMu"); // -- Titulo do Site
define("Server_Version", "99"); // -- Versão do Servidor
define("Server_Xp", "5.000x"); // -- Experiência do Servidor
define("Server_Drop", "80%"); // -- Drop do Servidor
define("Server_BB", 0); // -- Bug Bless [0=Offline] [1=Online] [2=Outro]
...
##################################################################
$_ServerList = array(0 => array("ViciadosMu", "Mu", 100),
					 );
...
$_RaffleSystem["Accounts"] = array("seulogindeadmaqui", "seulogindeadmaqui"); // -- Contas com permisão de gerenciar o sistema (Exemplo: "admin","adm2")
$_RaffleSystem["Raffle"] = array("seulogindeadmaqui", "seulogindeadmaqui"); // -- Contas com permisão para sortear jogadores (Exemplo: "admin","adm2")
$_RaffleSystem["Clear"] = array("seulogindeadmaqui", "seulogindeadmaqui"); // -- Contas com permisão para limpar a lista de sorteados (Exemplo: "admin","adm2")
...
define("Register[VIP][Type]", 1); // -- Tipo de VIP [De 1 a 5] (Padrão -> 1)
...
define("Register[ItemBonus]", false); // -- Habilitar o Item Bônus (Necessário licença adicional)
...
define("Forum_Link", "http://forum.seudominio.com.br"); // -- Link do Fórum
define("Num_Shops", 1); // -- Numero de Web Shops
define("Shop_Link", "/shop/"); // -- Link do Shop (Somente para 1 Shop)
##################################################################
	# Link dos Shops
	# Somente se tiver 2 ou mais
	# Exemplo: 0 => array("Link do Shop", "Nome do Shop"),
##################################################################
$_Shop = array(0 => array("/gold/", "Shop Gold"),
			   1 => array("/cash/", "Shop Cash"),
			   );
...
define("Chat_Scripts", '<embed src="http://www.xatech.com/web_gear/chat/chat.swf" quality="high" width="540" height="405" name="chat" FlashVars="id=158331371&rl=Brazilian" align="middle" allowScriptAccess="sameDomain" type="application/x-shockwave-flash" pluginspage="http://xat.com/update_flash.shtml" />'); // -- Script do Chat
...
******************************************************************************/
$_Menu = array(1 => array(2, "Hospedado por", "http://www.viciadosmu.com.br"),
			   );
...
/*****************************************************************************
	...
	@ false = Não
******************************************************************************/
define("Suportt_Forum", "http://forum.seudominio.com.br/"); // -- Link da Ártea de Suporte no Fórum (Caso Tenha Fórum)
define("Suportt_Phone", true); // -- Ativar/Desativar Suporte via telefone
##################################################################
	# E-Mails de Suporte
	# Exemplo: 0 => array("E-Mail", "Atendente"),
##################################################################
$_Suportt["Mail"] = array(0 => array("admin@seudominio.com.br", "ADMIN"),
			   			  1 => array("admin@seudominio.com.br", "ADMIN"),
						  );
##################################################################
...
##################################################################
$_Suportt["Phone"] = array(0 => array("(00) 0000000", "Admin", "Admin"),
			   			   1 => array("(00) 0000000", "Admin", "Admin"),
			   			  );
...
$_Panel["Financial"]["PagSeguro"] = array(0 /* Ativado */); // -- Módulo PagSeguro (Necessário licença adicional)
...
$_Panel["Char"]["Reset"]["General"]["Level"] = array(400 /* Free */,350 /* VIP 1 */,300 /* VIP 2 */,250 /* VIP 3 */,200 /* VIP 4 */,150 /* VIP 5 */); // -- Level Minimo
$_Panel["Char"]["Reset"]["General"]["Money"] = array(50000000 /* Free */,30000000 /* VIP 1 */,10000000 /* VIP 2 */,0 /* VIP 3 */,0 /* VIP 4 */,0 /* VIP 5 */); // -- Zen Requerido
$_Panel["Char"]["Reset"]["General"]["Return"] = array(1 /* Free */,1 /* VIP 1 */,6 /* VIP 2 */,10 /* VIP 3 */,20 /* VIP 4 */,25 /* VIP 5 */); // -- Level a Retornar
...
$_Panel["Char"]["Reset"]["General"]["Points"] = array(300 /* Free */,350 /* VIP 1 */,400 /* VIP 2 */,450 /* VIP 3 */,500 /* VIP 4 */,600 /* VIP 5*/); // -- Pontos a Ganhar
...
/************ Configurações do Master Reset ************
	@ O Sistema credita Moedas para as contas Resetadas
	@ Todos os pontos serão resetados
	@ Os Resets serão diminuidos caso ativado
*******************************************************/
$_Panel["Char"]["MReset"]["Level"] = array(400 /* Free */,350 /* VIP 1 */,300 /* VIP 2 */,280 /* VIP 3 */,250 /* VIP 4 */,230 /* VIP 5*/); // -- Level Minimo
...
$_Panel["Char"]["MReset"]["Stats"] = array(32767 /* Força */,32767 /* Agilidade */,32767 /* Vitalidade */,32767 /* Energia */,32767 /* Comando (Somente DL/LE */); // -- Stats Requeridos para dar o Master Reset
...
$_Panel["Char"]["MReset"]["Cash"] = array(1 /* Free */,2 /* VIP 1 */,3 /* VIP 2 */,4 /* VIP 3 */,5 /* VIP 4 */,6 /* VIP 5 */); // -- Moedas a Receber
$_Panel["Char"]["MReset"]["Coin"] = 1; // -- Número da Moeda a receber (1 a 3)
...
define("Siege_Enable", false); // -- Mostrar Informações do Castle Siege
...
$_Home["Board"]["Link"] = "http://forum.seudominio.com.br/board/smf"; // -- Link do Fórum
...
******************************************************************************/
$_BankList = array(0 => array("Banco Itaú", "0000", "000000-0", "Conta Corrente", "Titular"),
				  1 => array("Banco do Brasil", "0000", "000000-0", "Conta Corrente", "Titular"),
				  2 => array("Banco Caixa Federal", "0000", "000000-0", "Conta Corrente", "Titular"),
				  );
...
******************************************************************************/
define("Coin_Number", 1); // -- Numero de Moedas [De 1 a 3]
...
define("VIP_Credits", "creditos"); // -- Coluna de Tempo em numeros Inteiros (Padrão -> VIP_Integer)
