<div class="box">
<div class="s-header"><span>{News#Title}</span></div>
	<blockquote>
	<table width="98%" border="0" align="center" cellspacing="2" class="table">
	<tr>
...
<table width="450" border="0" align="center" class="table">
  <tr>
    <td align="center">
    <strong>Personagem:</strong></td>
    ...
    {News#Characters}
      ...
      <tr align="left">
        ...
        <td width="294">
        <a href="javascript: void(EffectWeb);" onclick="selTexto('Text', '[b]', '[/b]');"><img src="images/icons/bbcode/text_bold.png" border="0" /></a>
        ...
        <a href="javascript: void(EffectWeb);" onclick="selTexto('Text', '[right]', '[/right]');"><img src="images/icons/bbcode/text_align_right.png" border="0" /></a>
        </td>
      </tr>
      <tr>
