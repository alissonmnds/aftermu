...
<div class="box">
<div class="s-header"><span>Redefinir Senha</span></div>
<blockquote>
...
<p class="right colr"><span class="padding">Deseja alterar sua senha?</span>
<input type="button" value="Redefinir Senha" onclick="CTM_Load('?pag=recovery&run=true{Reset_Link}&cmd=true','Command','POST',BuscaElementosForm('Reset_Pwd'));" /></p>
	  </form>
	</blockquote>
	<div id="Command"></div>
</div>