...
<p class="colr right">Deseja alterar seu Nick?
<input type="button" value="Alterar Nick" onclick="CTM_Load('?pag=paneluser&str=CHANGE_NICK&cmd=true','Command','POST',BuscaElementosForm('New_Nick'));" /></p>
	  </form>
	</blockquote>
	<div id="Command"></div>