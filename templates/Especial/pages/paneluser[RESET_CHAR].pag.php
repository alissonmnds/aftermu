<div class="box">
<div class="min-header-box">Resetar Personagem ({Reset_Mode})</div>
	   <blockquote>
...
<br /><b class="colr">Deseja Resetar seu personagem?</b><br />
<input type="button" value="Resetar Personagem" onclick="CTM_Load('?pag=paneluser&str=RESET_CHAR&cmd=true','Command','GET');" class="left" />
<br />
</blockquote>
<div id="Command"></div>
</div>