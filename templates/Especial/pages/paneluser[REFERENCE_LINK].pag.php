<div class="box">
<div class="min-header-box">Link de Refer&ecirc;ncia</div>
<blockquote>
<p>O link de refer&ecirc;ncia serve para voc&ecirc; ajudar o servidor divulgando para seus amigos e pela internet.</p><br />
...
<br /><strong>Link de Refer&ecirc;ncia:</strong> <input type="text" name="Link" id="Link" value="{REFERENCE[LINK]}" size="50" readonly onclick="highlight(this);" />
<?php endif; ?>
</blockquote>
</div>