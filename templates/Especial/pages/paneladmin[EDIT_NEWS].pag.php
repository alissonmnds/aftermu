<div class="box">
<div class="min-header-box">Editar Noticia</div>
	<blockquote>
<form name="Edit_News" id="Edit_News">
<table width="452" border="0">
  <tr>
    <td width="146">Titulo:</td>
    <td width="296"><input type="text" name="Title" value="{Notice_Title}" id="Title" /></td>
  </tr>
  <tr>
    <td>Data:</td>
  ...
  <tr>
    ...
    <td><input type="checkbox" name="Comments_Enable" id="Comments_Enable" {Notice_Comments} /></td>
      ...
      <tr align="center">
        ...
        <td align="left"><a href="javascript: void(EffectWeb);" onclick="selTexto('Text', '[b]', '[/b]');"><img src="images/icons/bbcode/text_bold.png" border="0" /></a>
      ...
      <tr>
        <td align="center" colspan="41"><textarea name="Text" id="Text" cols="60" rows="7">{Notice_Text}</textarea></td>
      </tr>
      <tr>
