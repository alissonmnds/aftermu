<ul>
    ...
    <li>&raquo; <a href="javascript: void(EffectWeb);" onclick="CTM_Load('?pag=paneluser','conteudo','GET');">Painel de Controle</a></li>
    {PanelAdmin_Link}
    <li>&raquo; <a href="?exec=logout">Deslogar</a></li>
</ul>