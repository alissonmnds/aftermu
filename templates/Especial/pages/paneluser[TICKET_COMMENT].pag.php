<div id="Close_Ticket">
<div class="box">
<div class="min-header-box">Responder Ticket</div>
	<blockquote>
...
<table width="500" border="0" align="center">
        ...
        <td width="344" align="left"><a href="javascript: void(EffectWeb);" onclick="selTexto('Text', '[b]', '[/b]');"><img src="images/icons/bbcode/text_bold.png" border="0" /></a>
