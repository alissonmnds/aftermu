...
<table width="500" border="0" align="center">
  ...
  <tr>
    ...
    <td width="191"><input type="text" name="Code" id="Code" onKeyUp="this.value = this.value.toLowerCase();" maxlength="32" /></td>
  </tr>
  <? } ?>
  <tr>
  ...
  <tr>
    ...
    <td>
    <img src="{Captcha_Image}" style="border:none;" id="captcha" />
    <a href="javascript: void(EffectWeb);" onclick="Security_Captcha('captcha');">
    <img src="images/icons/refresh.png" border="0" title="Atualizar Codigo de Seguran&ccedil;a" />
    </a></td>
  </tr>
  <tr>
...
<p class="colr right">Deseja alterar seu E-Mail?
<input type="button" value="Alterar E-Mail" onclick="CTM_Load('?pag=paneluser&str=CHANGE_MAIL&run=true{Reset_Link}&cmd=true','Command','POST',BuscaElementosForm('Change_Mail'));" /></p>
	  </form>
      <br /><br />
	</blockquote>
	<div id="Command"></div>
