<div class="box">
<div class="min-header-box">Informa&ccedil;&otilde;es</div>
	   <blockquote>
  ...
  <tr>
    ...
    <td><b class="colr"><a href="javascript: void(EffectWeb);" onclick="Serial();return false;">{EffectWeb_Domain}</a></b></td>
  </tr>
  <tr>
    <td>Tipo de Licen&ccedil;a:</td>
    <td><b class="colr">{EffectWeb_License}</b></td>
  </tr>
  <tr>
    <td>Vencimento:</td>
  ...
  <tr>
    <td>E-Mail/MSN:</td>
    <td><b class="colr">{Developer_Mail}</b></td>
  </tr>
  <tr>
    <td>Skype:</td>
    <td><b class="colr">{Developer_Skype}</b></td>
  </tr>
  <tr>
    <td>Telefone:</td>
    <td><b class="colr">{Developer_Phone}</b></td>
  </tr>
  <tr>
