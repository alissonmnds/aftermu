<div class="box">
<div class="min-header-box">Gerenciar Aviso</div>
	<blockquote>
<form name="Warning" id="Warning">
<table width="500" border="0" align="center">
  <tr>
    <td width="146">Data:</td>
    <td width="344"><input type="text" value="{Warning_Date} as {Warning_Time}" name="Title" id="Title" disabled="disabled" /></td>
  </tr>
      <tr align="center">
