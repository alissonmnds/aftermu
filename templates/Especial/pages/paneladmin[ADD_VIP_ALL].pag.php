<div class="box">
<div class="min-header-box">Adicionar VIP em todas as Contas</div>
	   <blockquote>
...
<input type="button" value="Adicionar VIP" onclick="CTM_Load('?pag=paneladmin&str=ADD_VIP_ALL&cmd=true','Command','POST',BuscaElementosForm('Add_VIP'));" class="left" />
</form>
	</blockquote>
	<div id="Command"></div>
</div>