...
<blockquote><div id="TabbedPanels1" class="TabbedPanels">
  ...
  <div class="TabbedPanelsContentGroup">
    ...
    <div class="TabbedPanelsContent"><strong>Para obter {Coin_1} &eacute; simples:</strong><br />
	<ul>
	...
	<div class="TabbedPanelsContent">
	  <strong>Dados de contas Bancarias:</strong><br /><br />
  ...
  {Bank_List}
    ...
    <div class="TabbedPanelsContent"><strong>Conta VIP s&atilde;o privilegios que as contas Free n&atilde;o contem.<br />
      Existem {VIP_Number} tipos de contas VIPs:<br /></strong>
	  <ul>
      <li><b class="red">&raquo; {VIP_Name#1}</b></li>
      <?php
	  if(constant("VIP_Number") >= 2)
	  {
	  ?>
    ...
    <div class="TabbedPanelsContent">
      <table width="100%" border="0">
        <tr>
		  ...
		  {
		  ?>
          <td width="183" class="colr"><b>{VIP_Name#2}:</b></td>
          <?php
		  }
		  if(constant("VIP_Number") >= 3)
		  {
        ...
        <tr>
		  ...
		  {
		  ?>
          <td><img src="images/icons/{Advantages#Alt_Vault_VIP3}.png" style="border: none;" /></td>
          <?php
		  }
		  if(constant("VIP_Number") >= 4)
		  {
