<div class="box">
<div class="min-header-box">Resetar Pontos</div>
	   <blockquote>
		...
		<input type="button" value="Resetar Pontos" onclick="CTM_Load('?pag=paneluser&str=RESET_POINTS&cmd=true','Command','GET');" class="left" />
	</blockquote>
	<div id="Command"></div>
</div>