<div class="box">
<div class="min-header-box">Pagamento {Payment_Post#Date}</div>
	<blockquote>
...
<table width="500" border="0" align="center">
        ...
        <td><a href="javascript: void(EffectWeb);" onclick="selTexto('Text', '[b]', '[/b]');"><img src="images/icons/bbcode/text_bold.png" border="0" /></a>
